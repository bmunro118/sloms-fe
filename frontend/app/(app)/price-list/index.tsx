  ...
  return (
    <>
      <ScreenContent>
        ...
        {(featureFlags.priceListRevisions || featureFlags.priceListTypes) ? (
        <View style={styles.tabBar}>
          {(['items', ...(featureFlags.priceListRevisions ? ['revisions'] : []), ...(featureFlags.priceListTypes ? ['types'] : [])] as Tab[]).map((tab) => (
            <Pressable
              key={tab}
